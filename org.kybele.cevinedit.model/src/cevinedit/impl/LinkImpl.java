 ...
 * <ul>
 *   <li>{@link cevinedit.impl.LinkImpl#getBrightness <em>Brightness</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getColor <em>Color</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getLabelFontStyle <em>Label Font Style</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getSourceDecoration <em>Source Decoration</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getTargetDecoration <em>Target Decoration</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getTexture <em>Texture</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link cevinedit.impl.LinkImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class LinkImpl extends PersonalizedElementImpl implements Link {
	/**
	...
	protected EClass eStaticClass() {
		return CevineditPackage.Literals.LINK;
	}
	...
	public void setBrightness(Brightness newBrightness) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__BRIGHTNESS, oldBrightness, brightness));
	}
	...
	public void setColor(Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__COLOR, oldColor, color));
	}
	...
	public void setLabelFontStyle(FontStyle newLabelFontStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__LABEL_FONT_STYLE, oldLabelFontStyle, labelFontStyle));
	}
	...
	public void setSourceDecoration(LinkFigure newSourceDecoration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__SOURCE_DECORATION, oldSourceDecoration, sourceDecoration));
	}
	...
	public void setTargetDecoration(LinkFigure newTargetDecoration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__TARGET_DECORATION, oldTargetDecoration, targetDecoration));
	}
	...
	public void setTexture(Texture newTexture) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__TEXTURE, oldTexture, texture));
	}
	...
	public void setWidth(int newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__WIDTH, oldWidth, width));
	}
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CevineditPackage.LINK__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CevineditPackage.LINK__BRIGHTNESS:
				return getBrightness();
			case CevineditPackage.LINK__COLOR:
				return getColor();
			case CevineditPackage.LINK__LABEL_FONT_STYLE:
				return getLabelFontStyle();
			case CevineditPackage.LINK__SOURCE_DECORATION:
				return getSourceDecoration();
			case CevineditPackage.LINK__TARGET_DECORATION:
				return getTargetDecoration();
			case CevineditPackage.LINK__TEXTURE:
				return getTexture();
			case CevineditPackage.LINK__WIDTH:
				return getWidth();
			case CevineditPackage.LINK__LABEL:
				return getLabel();
		}
