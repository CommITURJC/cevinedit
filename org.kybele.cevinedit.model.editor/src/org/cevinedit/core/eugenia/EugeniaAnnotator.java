...
public class EugeniaAnnotator 
{
	...
	public static String generateArrayInt(String array[])
	{
		String s="";
	...
	public static Entry<String, String>  GMFNode_PolygonX(String pointsX[])
	{
		return createDetailEntry("polygon.x", generateArrayInt(pointsX));
	}	
	
	public static Entry<String, String>  GMFNode_PolygonY(String pointsY[])
	{
	...
	{
		if (!EugeniaArrowType.isArrow(target_arrow_type.toLowerCase()))
