...
public class CevineditEditorSearchImageListener  implements SelectionListener  {
	protected CevineditEditor _editor = null;
	public CevineditEditorSearchImageListener(CevineditEditor editor)
	{
		_editor = editor;
	}
	@Override
	public void widgetSelected(SelectionEvent e) {
			ResourceDialog rs_dialog = new ResourceDialog(_editor.getMainLayer().getShell(), "Select Image", SWT.NONE);
