 ...
 * <ul>
 *   <li>{@link mapping.impl.MappingElementImpl#getID <em>ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingElementImpl extends MinimalEObjectImpl.Container implements MappingElement {
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MAPPING_ELEMENT__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.MAPPING_ELEMENT__ID:
				return getID();
		}
