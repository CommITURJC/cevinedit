 ...
 * <ul>
 *   <li>{@link notation.impl.NodeImpl#getGraphicalElement <em>Graphical Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeImpl extends DiagramElementImpl implements Node {
	...
	public NotificationChain basicSetGraphicalElement(GraphicalElement newGraphicalElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NotationPackage.NODE__GRAPHICAL_ELEMENT, oldGraphicalElement, newGraphicalElement);
	...
	public void setGraphicalElement(GraphicalElement newGraphicalElement) {
		if (newGraphicalElement != graphicalElement) {
			...
			if (graphicalElement != null)
				msgs = ((InternalEObject)graphicalElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NotationPackage.NODE__GRAPHICAL_ELEMENT, null, msgs);
			if (newGraphicalElement != null)
				msgs = ((InternalEObject)newGraphicalElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NotationPackage.NODE__GRAPHICAL_ELEMENT, null, msgs);
			msgs = basicSetGraphicalElement(newGraphicalElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.NODE__GRAPHICAL_ELEMENT, newGraphicalElement, newGraphicalElement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NotationPackage.NODE__GRAPHICAL_ELEMENT:
