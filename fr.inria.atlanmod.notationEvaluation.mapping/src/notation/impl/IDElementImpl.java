 ...
 * <ul>
 *   <li>{@link notation.impl.IDElementImpl#getID <em>ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IDElementImpl extends MinimalEObjectImpl.Container implements IDElement {
	...
	protected EClass eStaticClass() {
		return NotationPackage.Literals.ID_ELEMENT;
	}
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.ID_ELEMENT__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NotationPackage.ID_ELEMENT__ID:
				return getID();
		}
